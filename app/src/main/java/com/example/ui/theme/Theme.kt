...
private val DarkColorScheme =
  darkColorScheme(
    primary = BentoBalanceContainer,
    secondary = BentoReferContainer,
    tertiary = BentoTasksContainer,
    background = BentoDarkNavy,
    surface = Color(0xFF1E2025),
    onPrimary = BentoDarkNavy,
...
fun MyApplicationTheme(
  ...
  // Dynamic color is disabled by default to preserve Bento Grid palette
